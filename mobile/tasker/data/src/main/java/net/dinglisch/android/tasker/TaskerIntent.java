package net.dinglisch.android.tasker;// Version 1.3.3
...
public class TaskerIntent extends Intent {
    ...
    public static enum Status {NotInstalled, NotEnabled, AccessBlocked, NoReceiver, OK}

    ;

    // -------------------------- PRIVATE VARS ---------------------------- //

    private final static String TAG = "net.dinglisch.android.tasker.TaskerIntent";
    ...
    // test we can send a net.dinglisch.android.tasker.TaskerIntent to Tasker
    ...
    // public access deprecated, use net.dinglisch.android.tasker.TaskerIntent.testSend() instead
