...
object TaskerPluginConstants {
   ...
   const val RESULT_CODE_OK_MINOR_FAILURES: Int = 1
   const val RESULT_CODE_FAILED: Int = 1 + 1
   const val RESULT_CODE_PENDING: Int = 1 + 2
   const val RESULT_CODE_UNKNOWN: Int = 1 + 3
}
