...
[<img src="docs/badge_obtainium.png" alt="Get it on Obtainium">](https://apps.obtainium.imranr.dev/redirect?r=obtainium://add/https://github.com/matejdro/PebbleTextSync)
[<img src="docs/badge_github.png" alt="Get it on GitHub">](../../releases/latest)

## Watchapp
[<img src="docs/badge_rebble.svg" alt="Get it on Rebble Store">](https://apps.rebble.io/en_US/application/6a3cc9bccd52370009f40d2d)
[<img src="docs/badge_github.png" alt="Get it on GitHub">](../../releases/latest)
...
* Double click DOWN - Scroll to the bottom
* Single click / hold UP - Scroll text up
* Double click UP - Scroll to the top
...
* Core watches with relatively recent firmware - 127 slots
